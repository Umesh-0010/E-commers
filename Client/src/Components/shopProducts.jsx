...
function ShopProduct({ items = [] }) {
  ...
  const handleToBuy = async () => {
    ...
    try {
      ...
      const response = await axiosClient.get(`/products/buy/${productId}`);
            ...
            <div className="p-6 flex flex-col gap-3">
              ...
              <div className="flex gap-3 mt-4">
                <button
                  ...
                  className="flex-1 bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 transition active:scale-95 disabled:opacity-50">
                  {loading.buyNow ? 'Processing...' : 'Buy now'}
                </button>
